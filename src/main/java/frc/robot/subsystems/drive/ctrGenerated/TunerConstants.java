...
public class TunerConstants {
    ...
    private static final double kFrontLeftEncoderOffset = -0.022217;
    private static final boolean kFrontLeftSteerInvert = true;

    private static final double kFrontLeftXPosInches = 11.865;
    ...
    private static final double kFrontRightEncoderOffset = 0.334961;
    private static final boolean kFrontRightSteerInvert = true;

    private static final double kFrontRightXPosInches = 11.865;
    private static final double kFrontRightYPosInches = -11.375;

    // Back Left
    private static final int kBackLeftDriveMotorId = 41;
    private static final int kBackLeftSteerMotorId = 40;
    private static final int kBackLeftEncoderId = 4;
    private static final double kBackLeftEncoderOffset = 0.125977;
    private static final boolean kBackLeftSteerInvert = true;

    private static final double kBackLeftXPosInches = -11.865;
    ...
    private static final double kBackRightEncoderOffset = 0.099365;
    private static final boolean kBackRightSteerInvert = true;

    private static final double kBackRightXPosInches = -11.865;
