...
public class Conversions {
    ...
    public static edu.wpi.first.math.geometry.Rotation2d inverse(edu.wpi.first.math.geometry.Rotation2d rotation2d) {
        if (hasTrig(rotation2d.getCos(), rotation2d.getSin())) {
            return new edu.wpi.first.math.geometry.Rotation2d(rotation2d.getCos(), -rotation2d.getSin());
        } else{
            return new edu.wpi.first.math.geometry.Rotation2d(-rotation2d.getRadians());
        }
    }

    private static boolean hasTrig(double x, double y) {
        return !Double.isNaN(y) && !Double.isNaN(x);
    }
